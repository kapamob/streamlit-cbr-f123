...
def cbr_f123():
    ...
    if v_try != 2:
        ...
        st.dataframe(df, column_order=("RANK","REGN","NAME_B","C3","C1"), column_config={"RANK":"№", "REGN":"Рег.номер", "NAME_B":"Наименование банка", "C3":"Значение капитала","C1":"rr"}, hide_index=True)
