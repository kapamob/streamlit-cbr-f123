...
def cbr_f102_charts():
    ...
    st.write("Динамика прибыли банков с 2012 года: годовые (верхний график) и ежеквартальные (нижний график) значения. Для просмотра на полный экран используйте элементы управления в правом верхнем углу графиков.")
